"""Tests for the server module of the Amazon MQ MCP server."""
...
class TestMain:
    ...
    def test_main_sse(self, mock_parse_args, mock_mcp):
    ...
    @patch('awslabs.amazon_mq_mcp_server.server.mcp')
    @patch('argparse.ArgumentParser.parse_args')
    def test_main_stdio(self, mock_parse_args, mock_mcp):
...
class TestAWSToolGenerator:
    ...
    def test_generator_configuration(self):
        ...
        assert 'Manage RabbitMQ and ActiveMQ message brokers on AmazonMQ' in mcp.instructions
