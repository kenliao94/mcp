...
class TestRabbitMQModuleToolExecution:
    ...
    def test_read_only_tools_execution_paths(self, mock_shovel, mock_shovels, mock_exchange_info, 
                                           mock_queue_info, mock_exchanges_vhost, mock_vhosts, 
                                           mock_exchanges, mock_queues_vhost, mock_queues):
    ...
    def test_mutative_tools_execution_paths(self, mock_delete_exchange, mock_purge_queue, 
                                          mock_delete_queue, mock_fanout, mock_enqueue):
